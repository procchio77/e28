    ...
    <div class="dropdown show-dropdown" :class="{ show: isOpen }">
      ...
      <ul class="dropdown-menu" :class="{ show: isOpen }">
        ...
        <li class="github-buttons">
          <gh-btns-star
            slug="creativetimofficial/ct-vue-material-dashboard-pro"
            show-count
          ></gh-btns-star>
        </li>
        ...
        <li class="button-container">
          <social-sharing
            :url="shareUrl"
            inline-template
            title="Vue Material Dashboard PRO - Premium Admin Template for Vue.js"
            hashtags="vuejs, dashboard, vuematerial"
            twitter-user="creativetim"
          >
            <div class="centered-buttons">
              <network network="twitter" class="md-button md-round md-twitter">
